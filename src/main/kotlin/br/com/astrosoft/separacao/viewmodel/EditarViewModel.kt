...
class EditarViewModel(view: IEditarView) : ViewModel<IEditarView>(view) {
  fun processar() = exec {
    ...
    val proximoNumero = Pedido.proximoNumeroPedidoLoja(pedido.storenoDestino, data)
    ...
    view.showInformation("Foi criado o pedido para o estoque de loja número $proximoNumero (${data.format()})")
...
data class PedidosLojaData(val numero: Int, val data: LocalDate)